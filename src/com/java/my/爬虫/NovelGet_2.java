 ...
 * explain  : 
 */
public class NovelGet_2 {
	
	public static void main(String[] args) {
		// 零点看书	唐砖
		String baseUrl = "http://m.00ksw.org/html/1/1115/";
        String nextUrl = "514190.html";	// 第一章
//		String nextUrl = "762418.html";
        String destFilePath = "D:\\唐砖.txt";

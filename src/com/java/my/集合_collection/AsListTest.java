...
/**
 * @author  : J
 * @version : Apr 21, 2017  3:03:26 PM
 * explain  : http://blog.csdn.net/cntanghai/article/details/7188296
 */
...
//        foreach(a_int_List); foreach(a_int); 
    ...
    public void test1(){
        String s1 = "1,2,3";
        String s2 = "1,2,3,2,3,34";
        List<String> fileIdList = new ArrayList<>();
        fileIdList.addAll(Arrays.asList(s1.split(",")));
        fileIdList.addAll(Arrays.asList(s2.split(",")));
//        System.out.println(JSON.toJSON(fileIdList));
